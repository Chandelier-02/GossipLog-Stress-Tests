...
export async function* sync(source, target, options) {
...
class Driver {
     ...
     */
    async *syncRoots(sourceNode, sourceUpperBound, targetRoot) {
        this.log("syncRoot");
        this.depth += 1;
    ...
    async *syncNodes(sourceNode, sourceUpperBound) {
        this.log("syncNode");
        this.depth += 1;
    ...
    async *syncLeaves(sourceNode, sourceUpperBound) {
