 ...
 */
export function verifySignedValue(signature, value, options = {}) {
 ...
 */
export function verifySignature({ publicKey: uri, signature, cid }, options = {}) {
    ...
    if (keyCodec === Ed25519Signer.code && types.includes(Ed25519Signer.type)) {
        ...
        assert(secp256k1.verify(secp256k1.Signature.fromCompact(signature), cid.bytes, publicKey), "invalid secp256k1 signature");
    }
    else {
