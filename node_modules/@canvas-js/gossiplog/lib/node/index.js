        ...
        return await this.env.read(async (txn) => {
            ...
            return await callback({
                ...
                heads: {
                    ...
                    entries: (lowerBound = null, upperBound = null, options = {}) => txn.entries(lowerBound, upperBound, { ...options, dbi: headsDBI }),
                },
            });
        });
    }
...
GossipLog.getReadOnlyAPI = (txn, dbi) => ({
    get: (key) => txn.get(key, { dbi }),
    entries: (lowerBound = null, upperBound = null, options = {}) => txn.entries(lowerBound, upperBound, { ...options, dbi }),
});
GossipLog.getReadWriteAPI = (txn, dbi) => ({
    get: (key) => txn.get(key, { dbi }),
